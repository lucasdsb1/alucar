...
public class ClienteDAO implements InterfaceCRUD<Cliente> {
    ...
    @Override
    public boolean insertIntoDB(Cliente c) {
    ...
    @Override
    public boolean alterIntoDB(Cliente c) {
    ...
    @Override
    public boolean deleteFromDB(Cliente c) {
    ...
    @Override
    public List<Cliente> listIntoDB() {
    ...
    @Override
    public List<Cliente> searchIntoDB(String CPF) {
